...
calculator.setMathBounds({
  ...
  columns: [
    ...
    },
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['6.77900552486188', '6.77900552486188']
    }
  ]
});
  calculator.setExpression({
...
calculator.setExpression({
  ...
  columns: [
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['1','10' ,'30' ,'50' ,'70' ,'90' ,'110' ,'130' ,'150' ,'170' ,'190' ,'210' ,'230' ,'250' ,'270' ,'290' ,'310' ,'330' ,'350' ,'370' ,'390' ,'410' ,'422']
    },
    {
      latex: 'y',
      color: "#6042a6",
 ...
 calculator.setExpression({ latex: '(211,6.77900552486188)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(211,16)', color: '#388c46', label: 'Highest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(211,0)', color: '#c74440', label: 'Lowest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(211,-6)', color: '#000000', label: 'Fun Fact / Quote / Riddle / MC Fact # (Date Format: M/D)', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(-25,8)', color: '#000000', label: '# of mentions', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(211, 26)', color: '#000000', label: 'Total Number of Mentions: 2,454', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(211, 24)', color: '#000000', label: 'Mean: 6.77900552486188 | Median: 6 | Mode: 4', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(211, 22)', color: '#000000', label: 'Range: 16 | Min: 0 | Max: 16', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(211, 20)', color: '#000000', label: 'Most used reaction: :nerd: (13 different times)', showLabel: true, hidden: true });
