...
calculator.setMathBounds({
  ...
  columns: [
    ...
    },
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['7.12933025404157', '7.12933025404157']
    }
  ]
});
  calculator.setExpression({
  ...
  columns: [
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['1','10' ,'30' ,'50' ,'70' ,'90' ,'110' ,'130' ,'150' ,'170' ,'190' ,'210' ,'230' ,'250' ,'270' ,'290' ,'310' ,'330' ,'350' ,'370' ,'390' ,'410' ,'430' ,'450' ,'470' ,'490' ,'508']
    },
    {
      latex: 'y',
      color: "#6042a6",
      lines: true,
      pointOpacity: 0,
      values: ['8','8' ,'10.3' ,'6.25' ,'5.55' ,'4.4' ,'4.3' ,'4.65' ,'4.35' ,'3.5' ,'3.15' ,'3.75' ,'2.75' ,'5.55' ,'9.45' ,'9.6' ,'9.8' ,'9.35' ,'11.3' ,'9.5' ,'9.25' ,'10.95' ,'9.9' ,'7.7' ,'8.15' ,'9' ,'10.125']
    }
  ]
});
 calculator.setExpression({ latex: '(254,7.12933025404157)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(254,18)', color: '#388c46', label: 'Highest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(254,0)', color: '#c74440', label: 'Lowest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(254,-6)', color: '#000000', label: 'Fun Fact / Quote / Riddle / MC Fact # (Date Format: M/D)', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(-25,9)', color: '#000000', label: '# of mentions', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(254, 26)', color: '#000000', label: 'Total Number of Mentions: 3,087', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(254, 24)', color: '#000000', label: 'Mean: 7.12933025404157 | Median: 7 | Mode: 4, 9', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(254, 22)', color: '#000000', label: 'Range: 18 | Min: 0 | Max: 18', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(254, 20)', color: '#000000', label: 'Most used reaction: :nerd: (13 different times)', showLabel: true, hidden: true });
