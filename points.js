...
calculator.setMathBounds({
  ...
  columns: [
    ...
    },
    {
      latex: 'y',
      color: "#000000",
      values: ['7', '11', '6', '12', '15', '9', '0', '0', '11', '0', '6', '6', '5', '8', '8', '8', '16', '12', '11', '9', '11', '14', '10', '11', '12', '13', '12', '8', '12', '12', '13', '15', '12', '13', '10', '7', '7', '4', '6', '4', '8', '7', '3', '4', '7', '6', '10', '9', '7', '7', '5', '5', '4', '6', '7', '10', '6', '5', '5', '4', '5', '4', '4', '9', '5', '8', '5', '7', '4', '3', '5', '4', '5', '8', '3', '4', '6', '6', '8', '8', '5', '7', '6', '4', '6', '5', '4', '3', '3', '5', '2', '4', '5', '4', '3', '6', '3', '5', '4', '4', '6', '6', '5', '5', '3', '3', '3', '4', '3', '1', '5', '6', '5', '5', '2', '4', '5', '6', '4', '5', '3', '6', '5', '3', '6', '6', '6', '5', '6', '4', '4', '5', '1', '3', '4', '7', '4', '6', '4', '5', '6', '8', '4', '4', '5', '4', '4', '2', '3', '5', '4', '5', '6', '6', '3', '3', '5', '4', '4', '2', '2', '5', '3', '2', '3', '3', '3', '2', '4', '2', '5', '3', '3', '5', '4', '6', '6', '1', '4', '4', '4', '3', '5', '3', '3', '3', '2', '4', '3', '4', '4', '3', '4', '3', '2', '2', '4', '1', '4', '2', '4', '3', '4', '4', '4', '3', '3', '3', '5', '4', '4', '5', '4', '4', '3', '3', '3', '4', '4', '4', '2', '1', '3', '3', '3', '1', '2', '3', '3', '4', '3', '3', '3', '3', '3', '3', '3', '3', '3', '3', '1', '2', '2', '3', '5', '3', '3', '3', '9', '12', '8', '5', '8', '7', '8', '8', '6', '6', '7', '5', '4', '8', '9', '12', '12', '10', '9', '8', '10', '9', '11', '10', '10', '11', '11', '11', '8', '8', '11', '7', '12', '10', '11', '12', '10', '10', '9', '9', '9', '10', '10', '11', '8', '11', '8', '7', '7', '9', '8', '11', '7', '11', '13', '12', '9', '10', '12', '12', '10', '12', '10', '11', '11', '9', '9', '7', '8', '7', '7', '9', '9', '8', '8', '9', '9', '9', '10', '9', '7', '10', '9', '7', '9', '11', '10', '10', '10', '11', '12', '10', '12', '13', '14', '11', '12', '13', '10', '9', '12', '13', '14', '12', '10', '10', '10', '11', '11', '10', '9', '10', '12', '11', '7', '9', '10', '8', '8', '10', '9', '9', '11', '10', '12', '9', '10', '9', '10', '9', '10', '7', '7', '8', '11', '9', '12', '12', '10', '8', '8', '9', '8', '9', '9', '6', '10', '10', '10', '10', '10', '9', '12', '11', '10', '11', '12', '14', '12', '10', '11', '10', '11', '10', '12', '11', '11', '10', '9', '9', '13', '10', '9', '11', '9', '9', '10', '9', '9', '11', '18', '10', '10', '9', '9', '8', '9', '11', '9', '10', '9', '9', '9', '10', '8', '7', '8', '4', '8', '8', '7', '9', '8', '8', '6', '6', '5', '5', '7', '10', '10', '11', '11', '8', '8', '7', '8', '9', '8', '7', '7', '6', '7', '6', '7', '7', '17', '8', '7', '9', '8', '8', '7', '8', '9', '10', '10', '9', '11', '10', '9', '9', '9', '9', '17', '8', '8', '7', '6', '7', '9', '8', '11', '9', '11', '10', '12', '10', '9', '9', '8', '8', '7', '7', '9', '9', '6', '6', '7', '7', '6', '8', '8', '8', '7', '8', '8', '9', '8', '8', '9', '9', '7', '7', '7', '7', '6', '7', '7', '7', '8', '8', '8', '7', '8', '8', '7', '9', '6', '8', '7', '6', '7']
    }
  ]
});
  calculator.setExpression({
  ...
  columns: [
    ...
    },
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['7.15384615384615', '7.15384615384615']
    }
  ]
});
  calculator.setExpression({
  ...
  columns: [
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['1','10' ,'30' ,'50' ,'70' ,'90' ,'110' ,'130' ,'150' ,'170' ,'190' ,'210' ,'230' ,'250' ,'270' ,'290' ,'310' ,'330' ,'350' ,'370' ,'390' ,'410' ,'430' ,'450' ,'470' ,'490' ,'510' ,'530' ,'551']
    },
    {
      latex: 'y',
      color: "#6042a6",
      lines: true,
      pointOpacity: 0,
      values: ['8','8' ,'10.3' ,'6.25' ,'5.55' ,'4.4' ,'4.3' ,'4.65' ,'4.35' ,'3.5' ,'3.15' ,'3.75' ,'2.75' ,'5.55' ,'9.45' ,'9.6' ,'9.8' ,'9.35' ,'11.3' ,'9.5' ,'9.25' ,'10.95' ,'9.9' ,'7.7' ,'8.15' ,'9' ,'8.45' ,'7.65' ,'7.36363636363636']
    }
  ]
});
 calculator.setExpression({ latex: '(275.5,7.15384615384615)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(275.5,18)', color: '#388c46', label: 'Highest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(275.5,0)', color: '#c74440', label: 'Lowest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(275.5,-6)', color: '#000000', label: 'Fun Fact / Quote / Riddle / MC Fact # (Date Format: M/D)', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(-25,9)', color: '#000000', label: '# of mentions', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(275.5, 26)', color: '#000000', label: 'Total Number of Mentions: 3,348', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(275.5, 24)', color: '#000000', label: 'Mean: 7.15384615384615 | Median: 7 | Mode: 9', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(275.5, 22)', color: '#000000', label: 'Range: 18 | Min: 0 | Max: 18', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(275.5, 20)', color: '#000000', label: 'Most used reaction: :nerd: (13 different times)', showLabel: true, hidden: true });
  ...
  calculator.setExpression({ latex: '(440,-3)', color: '#000000', label: '5/22', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(460,-3)', color: '#000000', label: '6/11', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(480,-3)', color: '#000000', label: '7/1', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(500,-3)', color: '#000000', label: '7/21', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(520,-3)', color: '#000000', label: '8/10', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(540,-3)', color: '#000000', label: '8/30', showLabel: true, hidden: true });
