...
calculator.setExpression({
 ...
 calculator.setExpression({ latex: '(213,6.8)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  ...
  calculator.setExpression({ latex: '(213, 26)', color: '#000000', label: 'Total Number of Mentions: 2,482', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(213, 24)', color: '#000000', label: 'Mean: 6.8 | Median: 6 | Mode: 4', showLabel: true, hidden: true });
