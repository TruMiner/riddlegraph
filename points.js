  ...
  columns: [
    ...
    },
    {
      ...
      color: "#2d70b3",
      columnMode: Desmos.ColumnModes.LINES,
      values: ['5.65760869565217', '5.65760869565217']
    }
  ]
});
  calculator.setExpression({
  ...
  calculator.setExpression({ latex: '(92,5.65760869565217)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(92,16)', color: '#388c46', label: 'Highest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(92,0)', color: '#c74440', label: 'Lowest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(92,-5)', color: '#000000', label: 'Fun Fact / Quote / Riddle # (Date Format: M/D)', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(-4,8)', color: '#000000', label: '# of mentions', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(92, 26)', color: '#000000', label: 'Total Number of Mentions: 1,041', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(92, 24)', color: '#000000', label: 'Mean: 5.65760869565217 | Median: 5 | Mode: 4', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(92, 22)', color: '#000000', label: 'Range: 16 | Min: 0 | Max: 16', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(92, 20)', color: '#000000', label: 'Most used reaction: :nerd: (12 different times)', showLabel: true, hidden: true });
