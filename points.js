...
calculator.setMathBounds({
  ...
  calculator.setExpression({ latex: '(185,6.26282051282051)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  ...
  calculator.setExpression({ latex: '(185, 26)', color: '#000000', label: 'Total Number of Mentions: 1,954', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(185, 24)', color: '#000000', label: 'Mean: 6.26282051282051 | Median: 5 | Mode: 4', showLabel: true, hidden: true });
