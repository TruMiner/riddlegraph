...
calculator.setMathBounds({
  ...
  columns: [
    ...
    },
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['6.65142857142857', '6.65142857142857']
    }
  ]
});
  calculator.setExpression({
  ...
  calculator.setExpression({ latex: '(205,6.65142857142857)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(205,16)', color: '#388c46', label: 'Highest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(205,0)', color: '#c74440', label: 'Lowest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(205,-6)', color: '#000000', label: 'Fun Fact / Quote / Riddle / MC Fact # (Date Format: M/D)', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(-25,8)', color: '#000000', label: '# of mentions', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(205, 26)', color: '#000000', label: 'Total Number of Mentions: 2,328', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(205, 24)', color: '#000000', label: 'Mean: 6.65142857142857 | Median: 6 | Mode: 4', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(205, 22)', color: '#000000', label: 'Range: 16 | Min: 0 | Max: 16', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(205, 20)', color: '#000000', label: 'Most used reaction: :nerd: (13 different times)', showLabel: true, hidden: true });
