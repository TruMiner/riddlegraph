...
calculator.setMathBounds({
  ...
  columns: [
    ...
    },
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['6.03389830508475', '6.03389830508475']
    }
  ]
});
  calculator.setExpression({
  ...
  calculator.setExpression({ latex: '(175,6.03389830508475)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(175,16)', color: '#388c46', label: 'Highest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(175,0)', color: '#c74440', label: 'Lowest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(175,-6)', color: '#000000', label: 'Fun Fact / Quote / Riddle / MC Fact # (Date Format: M/D)', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(-25,8)', color: '#000000', label: '# of mentions', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(175, 26)', color: '#000000', label: 'Total Number of Mentions: 1,780', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(175, 24)', color: '#000000', label: 'Mean: 6.03389830508475 | Median: 5 | Mode: 4', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(175, 22)', color: '#000000', label: 'Range: 16 | Min: 0 | Max: 16', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(175, 20)', color: '#000000', label: 'Most used reaction: :nerd: (12 different times)', showLabel: true, hidden: true });
