...
calculator.setMathBounds({
  ...
  columns: [
    ...
    },
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['5.98976109215017', '5.98976109215017']
    }
  ]
});
  calculator.setExpression({
  ...
  calculator.setExpression({ latex: '(173,5.98976109215017)', color: '#2d70b3', label: 'Average', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(173,16)', color: '#388c46', label: 'Highest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(173,0)', color: '#c74440', label: 'Lowest', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(173,-6)', color: '#000000', label: 'Fun Fact / Quote / Riddle / MC Fact # (Date Format: M/D)', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(-25,8)', color: '#000000', label: '# of mentions', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(173, 26)', color: '#000000', label: 'Total Number of Mentions: 1,755', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(173, 24)', color: '#000000', label: 'Mean: 5.98976109215017 | Median: 5 | Mode: 4', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(173, 22)', color: '#000000', label: 'Range: 16 | Min: 0 | Max: 16', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(173, 20)', color: '#000000', label: 'Most used reaction: :nerd: (12 different times)', showLabel: true, hidden: true });
