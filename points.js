...
calculator.setMathBounds({
  ...
  columns: [
    ...
    },
    {
      ...
      lines: true,
      pointOpacity: 0,
      values: ['6.73463687150838', '6.73463687150838']
    }
  ]
});
  calculator.setExpression({
  ...
  calculator.setExpression({ latex: '(209, 26)', color: '#000000', label: 'Total Number of Mentions: 2,411', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(209, 24)', color: '#000000', label: 'Mean: 6.73463687150838 | Median: 6 | Mode: 4', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(209, 22)', color: '#000000', label: 'Range: 16 | Min: 0 | Max: 16', showLabel: true, hidden: true });
  calculator.setExpression({ latex: '(209, 20)', color: '#000000', label: 'Most used reaction: :nerd: (13 different times)', showLabel: true, hidden: true });
